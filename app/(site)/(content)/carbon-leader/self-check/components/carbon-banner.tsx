...
const CarbonBanner = () => {
  return (
    <section className="relative flex h-[180px] w-full items-center px-4 md:h-[240px]">
      ...
      />
      <div className="relative container mx-auto flex h-full max-w-[1267px] flex-col items-start justify-center gap-1 md:gap-5">
        ...
        <Breadcrumb className="max-md:hidden">
          <BreadcrumbList className="text-foreground text-base">
            ...
            <BreadcrumbItem>
              ...
              <BreadcrumbPage className="font-bold">자가진단</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>
