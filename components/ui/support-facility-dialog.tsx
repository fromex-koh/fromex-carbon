...
import {
  ...
  useGetSupportFacilityModalOnload,
...
interface SupportFacilityDialogProps {
  setSupportFacility: (value: SupportFacility) => void
}

const SupportFacilityDialog = React.forwardRef<
  HTMLButtonElement,
  ButtonProps & SupportFacilityDialogProps
>(
  (
    {
      className,
    ...
    const {
      data: supportFacility,
      isFetching,
      isPending,
      error,
    } = useGetSupportFacilityModalOnload()

    const data = supportFacility?.data?.data?.supportFacilities
    ...
    const filteredData = data?.filter(
      (result) =>
        !debouncedKeyword ||
        result.sprtFcltNm?.includes(debouncedKeyword) ||
        result.sprtFcltClsf?.includes(debouncedKeyword),
    )
...
SupportFacilityDialog.displayName = "SupportFacilityDialog"
export { SupportFacilityDialog }
