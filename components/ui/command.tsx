...
const CommandInput = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof CommandPrimitive.Input> &
    CommandInputProps
>(({ className, hiddenIcon = false, divClassName, ...props }, ref) => (
  <div
    className={cn("flex items-center border-b px-3", divClassName)}
    cmdk-input-wrapper=""
  >
    {!hiddenIcon && <Search className="mr-2 h-4 w-4 shrink-0 opacity-50" />}
