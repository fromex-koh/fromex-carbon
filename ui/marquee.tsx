...
export default function Marquee({
  ...
  return (
    <div
      {...props}
      className={cn(
        "group relative flex h-full w-full gap-(--gap) p-2 [--duration:20s] [--gap:12px]",
        {
          "flex-col": vertical,
          "flex-row": !vertical,
        },
    ...
    >
      ...
      {applyMask && (
        <div
          className={cn(
            "pointer-events-none absolute inset-0 h-full w-full from-5% via-transparent via-50% to-white/50 to-95%",
            {
